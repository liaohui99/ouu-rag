 ...
 * @description: 日历助手
 */
@ConditionalOnMissingBean(ChartDisplayAssistant.class)
public interface ChartDisplayAssistant {
    ...
    @SystemMessage(fromResource = "chat-prompt.txt")
    //系统提示词
    String chat(@MemoryId long memoryId, @V("data") String data, @UserMessage String userMessage);
